...
func (a *App) registerRoutes(mux *http.ServeMux) {
	...
	// Table management.
	handle("GET /connections", a.requireAdmin(a.connectionsHandler))
	handle("POST /connections", a.requireAdmin(a.addConnectionHandler))
	handle("POST /connections/active", a.requireAdmin(a.setActiveConnectionHandler))
